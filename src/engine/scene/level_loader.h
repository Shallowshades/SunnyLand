...
private:
	...
	/**
	 * @brief 添加音效到指定的AudioComponent.
	 *
	 * @param soundJson 音效JSON
	 * @param audioComponent 音频组件指针
	 */
	void addSound(const nlohmann::json& soundJson, engine::component::AudioComponent* audioComponent);
